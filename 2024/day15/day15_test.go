...
func TestComputeGPSCoordinatesSum_Simple(t *testing.T) {
	var result = computeGPSCoordinatesSum(`########
#..O.O.#
##@.O..#
#...O..#
#.#.O..#
...
func TestComputeGPSCoordinatesSum_Complex(t *testing.T) {
	var result = computeGPSCoordinatesSum(`##########
#..O..O.O#
#......O.#
#.OO..O.O#
...
v^^>>><<^^<>>^v^<v^vv<>v^<<>^<^v^v><^<<<><<^<v><v<>vv>>v><v^<vv<>v^<<^`)
	if result != 10092 {
		t.Errorf("Got %d instead of 10092", result)
	}
}

func TestComputeGPSCoordinatesSum_Input(t *testing.T) {
	var result = computeGPSCoordinatesSum(`##################################################
...
^^>vv<^^vv>^>^^><><>><><<^vv><<><>>^<>>^^vvv<vvv<^^<<^^>^><v>>>^^vvv^>><<>>^><^<<>^<<^>v<v^<v^>^v>v>><^^>vv>v^><<v^<<>^>>vv>^vv<>v^>>^<>>^<vv<>^>>^><<<^>>v<>^>^>>vv^<<^^v^<v>v^v^<>^^>^><<>>><<^v^v^>><>^v^>v<>>>^v>vv^>><<v^>v>v<>^^^v>><vv<^^>^^>^>><<^<^v<^<<v>v><>>vv><v>^v^^^^>v<>^vv^v>^^v<><<<v>>^<^<<<v<<^^<<<>v><v<><^^><>v^^>v<><<vv^>v>^>v>v>vvv<vv^^v^><><<<^>v<<<<<>>vv>vv^v<<<<<>^>^>^><^v>>^^<<<<<^v^vv><^v^vv<vvv^v<^>>^^vv<<^v>v^^>v^v><^<<>^^^^<>v<v^<^<><vv>^><^>><^^>>^^^>v<>^<v>v>^v>>^v<^>>>^>><<<v>^<v^v<v><^v>>v<vv<^v^<^>^v<>>>^>>^>>^>>>>>^>^><vv>v><<^<<>><<<v^<<>v<>>^^<><<vvv^>v^><^>v<<^<>vv^><<^v<<<>vv><>v>>v<^>^<^^<<^<^vvv^<^<><^>v<^<<>>v<<^>>>>^<<v><vvv<^>>^v^<<^<^v>^><v<><>>>^v>vv^^<v<^^>>><<v^^v<<>><^><<<v^v^v><^>^<>><>vv^><^<>>v<<^>vv>^v><<^^vv<<v<^^^<^<<><>>>v<vv<v<^^v>>v<^>v<<^><<v<^^^><^<v<<>>v><^>v>v>vv<v^^<v<<><^>v>^>v<><v<^<vv^<<v>>><^>vv^>^<v>>><><v<^v<<v^^>^^v>>^>^>vv^<v<v^><<>^^vvv><>><v^<<<^>^>^<>>><v<><^>^^vv<^v>>><^v<>>^>^^^^>^v<>v>>v>v>>vv<>vvv>>v<>v<<vvv<<^v><^`)
	if result != 1515788 {
		t.Errorf("Got %d instead of 1515788", result)
	}
}

func TestComputeSecondWarehouseGPSCoordinatesSum_Simple(t *testing.T) {
	var result = computeSecondWarehouseGPSCoordinatesSum(`#######
#...#.#
#.....#
#..OO@#
#..O..#
...
func TestComputeSecondWarehouseGPSCoordinatesSum_Complex(t *testing.T) {
	var result = computeSecondWarehouseGPSCoordinatesSum(`##########
#..O..O.O#
#......O.#
#.OO..O.O#
...
v^^>>><<^^<>>^v^<v^vv<>v^<<>^<^v^v><^<<<><<^<v><v<>vv>>v><v^<vv<>v^<<^`)
	if result != 9021 {
		t.Errorf("Got %d instead of 9021", result)
	}
}

func TestComputeSecondWarehouseGPSCoordinatesSum_Input(t *testing.T) {
	var result = computeSecondWarehouseGPSCoordinatesSum(`##################################################
#.O#..O#.....##.O.O.OO#..OO..OO.......O....O.O.O.#
#.....O.#.....O.#..OO#....O#O..#OO#.#..#OO......O#
#.....OO...#..O.O.........OOO#..O...#O...O.O...OO#
...
^^>vv<^^vv>^>^^><><>><><<^vv><<><>>^<>>^^vvv<vvv<^^<<^^>^><v>>>^^vvv^>><<>>^><^<<>^<<^>v<v^<v^>^v>v>><^^>vv>v^><<v^<<>^>>vv>^vv<>v^>>^<>>^<vv<>^>>^><<<^>>v<>^>^>>vv^<<^^v^<v>v^v^<>^^>^><<>>><<^v^v^>><>^v^>v<>>>^v>vv^>><<v^>v>v<>^^^v>><vv<^^>^^>^>><<^<^v<^<<v>v><>>vv><v>^v^^^^>v<>^vv^v>^^v<><<<v>>^<^<<<v<<^^<<<>v><v<><^^><>v^^>v<><<vv^>v>^>v>v>vvv<vv^^v^><><<<^>v<<<<<>>vv>vv^v<<<<<>^>^>^><^v>>^^<<<<<^v^vv><^v^vv<vvv^v<^>>^^vv<<^v>v^^>v^v><^<<>^^^^<>v<v^<^<><vv>^><^>><^^>>^^^>v<>^<v>v>^v>>^v<^>>>^>><<<v>^<v^v<v><^v>>v<vv<^v^<^>^v<>>>^>>^>>^>>>>>^>^><vv>v><<^<<>><<<v^<<>v<>>^^<><<vvv^>v^><^>v<<^<>vv^><<^v<<<>vv><>v>>v<^>^<^^<<^<^vvv^<^<><^>v<^<<>>v<<^>>>>^<<v><vvv<^>>^v^<<^<^v>^><v<><>>>^v>vv^^<v<^^>>><<v^^v<<>><^><<<v^v^v><^>^<>><>vv^><^<>>v<<^>vv>^v><<^^vv<<v<^^^<^<<><>>>v<vv<v<^^v>>v<^>v<<^><<v<^^^><^<v<<>>v><^>v>v>vv<v^^<v<<><^>v>^>v<><v<^<vv^<<v>>><^>vv^>^<v>>><><v<^v<<v^^>^^v>>^>^>vv^<v<v^><<>^^vvv><>><v^<<<^>^>^<>>><v<><^>^^vv<^v>>><^v<>>^>^^^^>^v<>v>>v>v>>vv<>vvv>>v<>v<<vvv<<^v><^`)
	if result != 1516544 {
		t.Errorf("Got %d instead of 1516544", result)
	}
}
